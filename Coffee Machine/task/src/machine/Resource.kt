...
sealed class Resource(amount: Int, val name: String) {

    var amount = amount
        private set

    open fun availableStatus() = "$amount of $name"
    ...
    class Money(amount: Int) : Resource(amount, "money") {
        override fun availableStatus(): String {
            return "\$${super.availableStatus()}"
        }
    }
}